...
/*   Updated: 2026/04/21 21:06:13 by yucchen          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	init_ray(t_ray *ray, t_map_info *map, int x)
{
...
static void	perform_dda(t_ray *ray, t_map_info *map)
{
	while (ray->hit == 0)
	{
...
static void	calculate_texture_x(t_ray *ray, t_map_info *map)
{
	double	wall_x;
